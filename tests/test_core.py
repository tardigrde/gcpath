...
def test_folder_path_simple():
    ...
    f2 = Folder(name="folders/2", display_name="f2", ancestors=["folders/2", "folders/1", "organizations/123"], organization=org_node)
...
def test_hierarchy_get_path_by_resource_name():
    ...
    p1 = Project(name="projects/p1", project_id="p1", display_name="Project 1", parent="folders/1", organization=org_node, folder=f1)
